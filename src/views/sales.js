...
export function setSalesSearch(val) { _salesSearch = (val || '').toLowerCase(); _salePage = 0; clearTimeout(_salesSearchTimer); _salesSearchTimer = setTimeout(renderSalesView, 200); }
