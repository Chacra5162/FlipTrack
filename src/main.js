...
// ââ Features (lazy-loaded â heavy modules loaded on first use) âââââââââââââââ
...
function updateThemeLabels() {
  ...
  if (btn) btn.textContent = isLight ? 'ð' : 'â';
...
(async function boot() {
  ...
  // Dismiss splash screen (always â even if boot partially fails)
  ...
  // Boot auth (connects Supabase, starts realtime) â MUST await to prevent race conditions
