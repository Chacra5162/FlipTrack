...
// ââ SMOKE EXPOSURE 3-POSITION SLIDER âââââââââââââââââââââââââââââââââââââââââ
...
export function updateSmokeSlider(pfx) {
  ...
  // v === 1 is neutral â no highlights
...
export function addItem(){
  ...
  save(); closeAdd(); refresh(); _sfx.create(); toast('Item added â');
